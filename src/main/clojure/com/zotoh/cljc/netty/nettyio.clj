...
(ns ^{ :doc "" :author "kenl" }
  ...
  (:require [com.zotoh.cljc.util.fileutils :as FU])
...
(defprotocol NettyServiceIO
  (onerror [this ^Channel ch ^com.zotoh.cljc.net.netutils.HTTPMsgInfo msginfo ^Throwable exp] )
  (onreq [this ^Channel ch ^com.zotoh.cljc.net.netutils.HTTPMsgInfo msginfo ^XData xdata] )
  (onres [this ^Channel ch ^com.zotoh.cljc.net.netutils.HTTPMsgInfo msginfo ^XData xdata] ))
...
(defn- make-cf-lsnr [^com.zotoh.cljc.net.netutils.HTTPMsgInfo msginfo]
...
(defn- nio-extract-req [^HttpRequest req]
  (let [ decr (QueryStringDecoder. (.getUri req))
    ...
    (com.zotoh.cljc.net.netutils.HTTPMsgInfo.
...
(defn- reply-xxx [ch s]
  (let [ res (DefaultHttpResponse. (HttpVersion/HTTP_1_1) s)
    ...
    (doto (.write ch res)
      (.addListener (make-cf-lsnr (com.zotoh.cljc.net.netutils.HTTPMsgInfo. "" "" "" false kalive 0 {} {}))))))
